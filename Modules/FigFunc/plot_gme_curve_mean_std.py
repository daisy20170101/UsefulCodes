...
def plot_gme_curve_mean_std(modelname, gmTable,rjb, sa1,sa3,sa0_3,figsize_single,imd='sa1'):
    ...
    nbins = int(20)
    rjb_bins = np.logspace(1,100,nbins)
    ...
    if imd=='sa1':
        ...
        plt.plot(rjb_bins, mean_bins,'-',c='royalblue',markersize=0.7,label='simulation mean')
        plt.plot(rjb_bins, mean_bins-std_bins,'--',c='royalblue',markersize=0.7,label='simulation mean +/-std')
        plt.plot(rjb_bins, mean_bins+std_bins,'--',c='royalblue',markersize=0.7)
