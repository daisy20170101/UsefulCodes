...
def plot_gme_hik(pgv,sa1,sa3,triang,coast_table, hik_trace, faultTable,modelname='test1', imd='pgv'):
    ...
    if imd=='sa1':
        ...
        sc = ax0.tripcolor(triang,pgv[:],cmap=Cmap2, shading='flat',vmin=0,vmax=1.4)
        cl = fig.colorbar(sc,ax=ax0)
    ...
    ax0.set(xlim=( epi300[0]-120e3, epi300[0]+170e3),ylim=(epi300[1]-100e3,epi300[1]+170e3))
...
def plot_gme_crust(pgv,sa1,sa3,triang,coast_table, faultTable,modelname='test1',  imd='pgv'):
    ...
    # ax0.set_yticks(lat_ticks)
    ax0.set(xlim=( epi230[0]-50e3, epi230[0]+50e3),ylim=(epi230[1]-50e3,epi230[1]+70e3))
