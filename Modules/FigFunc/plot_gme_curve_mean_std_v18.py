...
def plot_gme_curve_mean_std(modelname, gmTable,rjb, sa1,sa3,sa0_3,figsize_single,imd='sa1'):
    ...
    if imd=='sa1':
        ...
        plt.plot(rjb/1e3,sa1/9.8,'.',c='skyblue',markersize=0.7)
        ...
        plt.plot(rjb_bins[0:-1], 10**(mean_bins - 1.28*std_bins)/9.8,'--',c='royalblue',markersize=0.7,label='simulation mean +/-std')
    ...
    plt.grid(linestyle='-',which='both',linewidth=0.7)
